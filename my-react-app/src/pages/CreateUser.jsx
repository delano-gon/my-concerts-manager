...
export default function CreateUser() {
  return (
    <form className="flex max-w-4xl flex-col justify-center ml-48 px-12 py-6 lg:px-8">
      <div className="space-y-12">
        <div className="border-b border-gray-500 pb-12">
          <h1 className="text-base text-4xl font-bold leading-7 text-gray-200 mb-10 mt-6">Create a New Account</h1>
          ...
          <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
            <div className="sm:col-span-4">
              ...
              <div className="mt-2">
                <div className="flex shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 sm:max-w-md">
                  <span className="flex select-none items-center pl-3 text-gray-300 sm:text-sm">workcation.com/</span>
                  <input
                    type="text"
                    name="username"
                    id="username"
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2">
                <textarea
                  ...
                  name="about"
                  rows={3}
                  className="block w-full bg-transparent border-0 py-1.5 text-gray-300 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                  defaultValue={''}
                />
              </div>
            ...
            <div className="col-span-full">
              ...
              <div className="mt-2 flex items-center gap-x-3">
                ...
                <button
                  type="button"
                  className="bg-white px-2.5 py-1.5 text-sm font-semibold text-gray-900 shadow-sm hover:text-gray-300 hover:bg-purple-700"
                >
                  Change
                </button>
              </div>
              ...
              <div className="mt-2 flex justify-center border border-dashed px-6 py-10">
                <div className="text-center">
                  ...
                  <div className="mt-4 flex text-sm leading-6 text-gray-600">
                    <label
                      htmlFor="file-upload"
                      className="p-2 relative cursor-pointer bg-white font-semibold text-purple-900 focus-within:outline-none focus-within:ring-2 focus-within:ring-purple-700 focus-within:ring-offset-2 hover:text-gray-300 hover:bg-purple-700"
                    >
                  ...
                  <p className="pt-2 text-xs leading-5 text-gray-300">PNG, JPG, GIF up to 10MB</p>
                </div>
              </div>
            </div>
          </div>
