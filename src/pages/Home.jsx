import { PlusIcon, LockClosedIcon, ServerIcon } from '@heroicons/react/20/solid'
import image from '../assets/IntroductionImage.jpg'

export default function Home() {
  return (
    <div className="overflow-hidden bg-black px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:mx-0 lg:max-w-none lg:grid-cols-2 lg:items-start lg:gap-y-10">
        ...
        <div className="-ml-12 -mt-12 p-12 lg:top-4 lg:col-start-2 lg:row-span-2 lg:row-start-1 lg:overflow-hidden min-[320px]:size-fit sm:size-full">
          <img
            className="w-[48rem] max-w-none rounded-xl bg-gray-900 shadow-xl ring-1 ring-gray-400/10 min-[320px]:w-[27rem] sm:w-[57rem]"
            src={image}
            alt=""
          />
        </div>
